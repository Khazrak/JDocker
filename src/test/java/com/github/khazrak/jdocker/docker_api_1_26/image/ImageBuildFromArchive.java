...
import com.github.khazrak.jdocker.api126.requests.BuildImageFromArchiveRequest126;
...
public class ImageBuildFromArchive {
    ...
    @ClassRule
    public static HoverflyRule hoverflyRule = HoverflyRule.inCaptureOrSimulationMode("1_26/image_build_from_archive.json");
