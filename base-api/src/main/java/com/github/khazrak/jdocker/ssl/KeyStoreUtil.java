...
public class KeyStoreUtil {
    ...
    static void addCA(KeyStore keyStore, String caPath) throws IOException, CertificateException {
    ...
    static Collection<Certificate> loadCertificates(String certPath) throws IOException, CertificateException {
