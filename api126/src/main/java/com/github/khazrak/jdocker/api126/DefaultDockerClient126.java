...
import com.github.khazrak.jdocker.api126.handlers.*;
import com.github.khazrak.jdocker.api126.model.*;
...
public class DefaultDockerClient126 implements DockerClient {
    ...
    public DefaultDockerClient126(String host) {
    ...
    public DefaultDockerClient126(String host, String certPath) throws IOException, GeneralSecurityException {
    ...
    private ObjectMapper getMapper() {
        ...
        module.addAbstractTypeMapping(IndexConfig.class, IndexConfig126.class);
        module.addAbstractTypeMapping(ImageInfo.class, ImageInfo126.class);
        module.addAbstractTypeMapping(ImageSearchInfo.class, ImageSearchInfo126.class);
        module.addAbstractTypeMapping(HostPort.class, HostPort126.class);
        module.addAbstractTypeMapping(Ulimit.class, Ulimit126.class);
        module.addAbstractTypeMapping(Mount.class, Mount126.class);
        module.addAbstractTypeMapping(NetworkInterface.class, NetworkInterface126.class);
        module.addAbstractTypeMapping(ImageInspect.class, ImageInspect126.class);
        module.addAbstractTypeMapping(ImageHistoryInfo.class, ImageHistoryInfo126.class);
        module.addAbstractTypeMapping(NetworkCreateIpamConfig.class, NetworkCreateIpamConfig126.class);
        module.addAbstractTypeMapping(NetworkContainer.class, NetworkContainer126.class);
        module.addAbstractTypeMapping(NetworkIPAMConfig.class, NetworkIPAMConfig126.class);
        module.addAbstractTypeMapping(Network.class, Network126.class);
        module.addAbstractTypeMapping(Volume.class, Volume126.class);
        module.addAbstractTypeMapping(ExecInfo.class, ExecInfo126.class);
        module.addAbstractTypeMapping(Container.class, Container126.class);
        module.addAbstractTypeMapping(ContainerPort.class, ContainerPort126.class);
        module.addAbstractTypeMapping(ContainerInspect.class, ContainerInspect126.class);
        module.addAbstractTypeMapping(ContainerProcesses.class, ContainerProcesses126.class);
        module.addAbstractTypeMapping(NetworkStats.class, NetworkStats126.class);
        module.addAbstractTypeMapping(IOServiceBytes.class, IOServiceBytes126.class);
        module.addAbstractTypeMapping(ContainerStats.class, ContainerStats126.class);
        module.addAbstractTypeMapping(Warnings.class, Warnings126.class);
        module.addAbstractTypeMapping(FileSystemInfo.class, FileSystemInfo126.class);
        module.addAbstractTypeMapping(ContainerCommitRequestMount.class, ContainerCommitRequestMount126.class);
        module.addAbstractTypeMapping(ContainerFileSystemChange.class, ContainerFileSystemChange126.class);
