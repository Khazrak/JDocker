...
public class EasyContainer126 {

    public EasyContainer126(String imageName) {
        this(new DockerImageName(imageName));
    }

    public EasyContainer126(DockerImageName imageName) {
    ...
    public EasyContainer126 addPublishPort(String hostIp, int hostPort, int containerPort) {
    ...
    public EasyContainer126 addEnvVariable(String key, String value) {
        requestBuilder.environmentVariable(key + "=" + value);
        return this;
    }

    public EasyContainer126 cmd(String command) {
        this.command = command;
        return this;
    }

    public EasyContainer126 name(String containerName) {
        this.containerName = containerName;
        return this;
    }

    public EasyContainer126 net(String net) {
        this.net = net;
        return this;
    }

    public EasyContainer126 addAlias(String alias) {
        aliases.add(alias);
        return this;
    }

    public EasyContainer126 addLink(String link) {
        links.add(link);
        return this;
    }

    public EasyContainer126 addVolume(Path containerPath) {
        requestBuilder.volume(containerPath.toAbsolutePath().toString(), new Object());
        return this;
    }

    public EasyContainer126 addVolume(String volumeName, Path connectionPath) {
        binds.add(volumeName + ":" + connectionPath.toAbsolutePath().toString());
        return this;
    }

    public EasyContainer126 addHostVolume(Path hostPath, Path containerPath) {
