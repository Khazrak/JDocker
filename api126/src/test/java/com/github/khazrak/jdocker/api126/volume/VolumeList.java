package com.github.khazrak.jdocker.api126.volume;
...
import com.github.khazrak.jdocker.api126.requests.ListVolumeParams126;
...
public class VolumeList {
    ...
    public void listFiltersDanglingTrue() {
        ListVolumeParams params = ListVolumeParams126.builder().dangling(true).build();
    ...
    public void listFiltersDanglingFalse() {
        ListVolumeParams params = ListVolumeParams126.builder().dangling(false).build();
        List<Volume> volumeList = client.listVolumes(params);
