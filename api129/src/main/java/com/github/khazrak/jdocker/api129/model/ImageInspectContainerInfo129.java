...
@Getter
@Builder
@JsonDeserialize(builder = ImageInspectContainerInfo129.ImageInspectContainerInfo129Builder.class)
public class ImageInspectContainerInfo129 implements ImageInspectContainerInfo {
    ...
    public static class ImageInspectContainerInfo129Builder {
