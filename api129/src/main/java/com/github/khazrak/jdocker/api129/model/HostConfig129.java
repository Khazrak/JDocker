...
@Getter
@Builder
@JsonDeserialize(builder = HostConfig129.HostConfig129Builder.class)
public class HostConfig129 implements HostConfig {
    ...
    public static class HostConfig129Builder {
        ...
        @JsonDeserialize(as = LogConfig129.class)
        @JsonProperty("LogConfig")
        private LogConfig logConfig = new LogConfig129("", new TreeMap<String, String>());

        @JsonProperty("NetworkMode")
        private String networkMode = "default";

        @JsonDeserialize(as = RestartPolicy129.class)
        @JsonProperty("RestartPolicy")
        private RestartPolicy restartPolicy = new RestartPolicy129("no", 0);
