...
@Getter
@Builder
@JsonDeserialize(builder = ExecInfo129.ExecInfo129Builder.class)
public class ExecInfo129 implements ExecInfo {
    ...
    public static class ExecInfo129Builder {
        ...
        @JsonDeserialize(as = ProcessConfig129.class)
