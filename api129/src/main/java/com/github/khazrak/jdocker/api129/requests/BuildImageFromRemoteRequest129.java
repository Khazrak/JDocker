...
@Getter
@Builder
public class BuildImageFromRemoteRequest129 implements BuildImageFromRemoteRequest {

    private static final Logger logger = LoggerFactory.getLogger(BuildImageFromRemoteRequest129.class);
