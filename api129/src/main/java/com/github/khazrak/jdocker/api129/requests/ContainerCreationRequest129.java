...
@Getter
@Builder
public class ContainerCreationRequest129 implements ContainerCreationRequest {
    ...
    public static class ContainerCreationRequest129Builder {
        private String hostname = "";
        private String domainname = "";
        private String user = "";
        private String workingDir = "";
        private String stopSignal = "SIGTERM";
        private NetworkingConfig networkingConfig = new NetworkingConfig129();
    }
