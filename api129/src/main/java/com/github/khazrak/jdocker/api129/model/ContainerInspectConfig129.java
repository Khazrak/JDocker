...
@Builder
@Getter
@JsonDeserialize(builder = ContainerInspectConfig129.ContainerInspectConfig129Builder.class)
public class ContainerInspectConfig129 implements ContainerInspectConfig {
    ...
    public static class ContainerInspectConfig129Builder {
