...
@Builder
@ToString
@JsonDeserialize(builder = NetworkSettings129.NetworkSettings129Builder.class)
public class NetworkSettings129 implements NetworkSettings {
    ...
    public static class NetworkSettings129Builder {
        @JsonProperty("Bridge")
        private String bridge;
