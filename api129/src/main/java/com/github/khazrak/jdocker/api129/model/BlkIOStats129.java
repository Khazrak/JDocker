...
@Getter
@Builder
@JsonDeserialize(builder = BlkIOStats129.BlkIOStats129Builder.class)
public class BlkIOStats129 implements BlkIOStats {
    ...
    public static class BlkIOStats129Builder {
