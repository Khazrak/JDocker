...
public class NetworkList {
    ...
    @ClassRule
    public static HoverflyRule hoverflyRule = HoverflyRule.inCaptureOrSimulationMode("1_29/network_list.json");
    ...
    public void listByname() {
        NetworkListParams params = NetworkListParams129.builder().name("test1").build();
    ...
    public void listByDriver() {
        NetworkListParams params = NetworkListParams129.builder().driver("bridge").build();
