...
public class ImagePull {
    ...
    @ClassRule
    public static HoverflyRule hoverflyRule = HoverflyRule.inCaptureOrSimulationMode("1_29/image_pull.json");
    ...
    public void pullAuth() {
        ...
        AuthConfig authConfig = AuthConfig129.builder().username("username").password("password").email("test@test.se").build();
