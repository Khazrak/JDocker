...
public class ImageTarballImport {
    ...
    @ClassRule
    public static HoverflyRule hoverflyRule = HoverflyRule.inCaptureOrSimulationMode("1_29/image_tarball_import.json");
    ...
    public void importBusyBox() {
        ...
        try {
            ...
            filePath = Paths.get(classLoader.getResource("1_29/busybox-image.tar").toURI());
